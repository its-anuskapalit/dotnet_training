...
namespace ItTechGenie.M1.IComparable.WarmUp
{
    ...
    public class SupportTicket : IComparable<SupportTicket>          // IComparable<T> enables Sort()
    {
        ...
        public int CompareTo(SupportTicket? other)
        {
            ...
            return Priority.CompareTo(other.Priority) switch
            {
                0 => CreatedAt.CompareTo(other.CreatedAt) switch
                {
                    0 => string.Compare(TicketId, other.TicketId, StringComparison.Ordinal),
                    var result => result
                },
                var result => result
            };
